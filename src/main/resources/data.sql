...
-- 부서
INSERT IGNORE INTO departments (department_name, created_at) VALUES ('영업부', NOW());
INSERT IGNORE INTO departments (department_name, created_at) VALUES ('생산부', NOW());
INSERT IGNORE INTO departments (department_name, created_at) VALUES ('출하부', NOW());
INSERT IGNORE INTO departments (department_name, created_at) VALUES ('경영지원부', NOW());

-- 직급 (level 1 = 결재 권한 있음)
INSERT IGNORE INTO positions (position_name, position_level, created_at) VALUES ('팀장', 1, NOW());
INSERT IGNORE INTO positions (position_name, position_level, created_at) VALUES ('팀원', 2, NOW());

-- 사용자 (비밀번호: password123 -> BCrypt 해시)
-- 사번 형식: YYMMDDNN (입사일+순번)

-- ADMIN (경영지원부 팀장)
INSERT IGNORE INTO users (employee_no, user_name, user_email, user_pw, user_role, user_status, department_id, position_id, created_at, updated_at)
