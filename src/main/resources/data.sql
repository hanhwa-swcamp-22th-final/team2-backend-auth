...
VALUES ('EMP001', '관리자', 'admin@hanwha.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'ADMIN', '재직', 4, 1, NOW(), NOW());

-- 영업부
INSERT INTO users (employee_no, user_name, user_email, user_pw, user_role, user_status, department_id, position_id, created_at, updated_at)
VALUES ('EMP002', '김영업', 'kim.sales@hanwha.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'SALES', '재직', 1, 2, NOW(), NOW());
...
-- 출하부
INSERT INTO users (employee_no, user_name, user_email, user_pw, user_role, user_status, department_id, position_id, created_at, updated_at)
VALUES ('EMP006', '정출하', 'jung.ship@hanwha.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'SHIPPING', '재직', 3, 2, NOW(), NOW());

-- 퇴직자
INSERT INTO users (employee_no, user_name, user_email, user_pw, user_role, user_status, department_id, position_id, created_at, updated_at)
VALUES ('EMP007', '강퇴직', 'kang.quit@hanwha.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'SALES', '퇴직', 1, 2, NOW(), NOW());
